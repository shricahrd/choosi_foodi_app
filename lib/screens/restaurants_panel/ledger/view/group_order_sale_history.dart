...
import '../controller/group_order_sales_controller.dart';

class GOSaleHistoryScreen extends StatefulWidget {
  dynamic commission;

  GOSaleHistoryScreen({this.commission});

  @override
  _GOSaleHistoryScreenState createState() =>
      _GOSaleHistoryScreenState(commission);
}

class _GOSaleHistoryScreenState extends State<GOSaleHistoryScreen> {
  dynamic commission;

  _GOSaleHistoryScreenState(dynamic commission) {
    this.commission = commission;
  }

  final GOSalesHistoryController _getSalesController =
      Get.put(GOSalesHistoryController());
  ...
  var finalUri = GeneralPath.API_REST_GROUP_ORDER_SALES_LIST;
  ...
  void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) {
    ...
    if (args.value.startDate != null && args.value.endDate != null) {
      setState(() {
        _startDate = formatterMonth.format(args.value.startDate).toString();
        ...
        endSearch = DateTime.parse(args.value.endDate.toString())
            ...
            .millisecondsSinceEpoch;
        debugPrint('Start: $startSearch, end: $endSearch');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: WidgetAppbar.simpleAppBar(context,goSaleHistoryTxt, true),
      body: SafeArea(
        ...
        return networkManager.connectionType == 0
            ...
            : Column(
                children: [
                                ...
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (val) {
                                    _getSalesController.callGetSalesHistoryAPI(
                                        finalUri + "&searchKey=$val");
                                  },
                                  onChanged: (val) {
                                    if (val.isEmpty) {
                                      _getSalesController
                                          .callGetSalesHistoryAPI(finalUri);
                                    }
                                  },
                                  style: TextStyle(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            onTap: () {
                              debugPrint('Searchkey: ${_searchCtr.text}');
                              debugPrint('startSearch: $startSearch');
                  ...
                  GetBuilder<GOSalesHistoryController>(builder: (logic) {
                            ...
                            : Expanded(
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      // debugPrint('commissionAmt: $commissionAmt');
                                      // debugPrint('youEarned: $youEarned');
  ...
  onClickExport({required RestGroupOrderModel normalRestOrderModel}) {
    // createExcel
