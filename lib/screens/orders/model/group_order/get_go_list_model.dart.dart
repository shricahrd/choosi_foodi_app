...
class GetGoListModel {
  final Meta? meta;
  final List<MainDataList>? data;
  ...
  factory GetGoListModel.fromJson(Map<String, dynamic>? json) => GetGoListModel(
    meta: Meta.fromJson(asT<Map<String, dynamic>>(json, 'meta')),
    data: asT<List>(json, 'data').map((e) => MainDataList.fromJson(e)).toList(),
  );
...
class MainDataList {
  ...
  factory MainDataList.fromJson(Map<String, dynamic>? json) => MainDataList(
  ...
  Map<String, dynamic> toJson() => {
    'metadata': metadata.map((e) => e.toJson()),
    'data': data.map((e) => e.toJson()),
  };
}
...
class DataItem {
  ...
  factory DataItem.fromJson(Map<String, dynamic>? json) => DataItem(
    ...
    total: asT<dynamic>(json, 'total'),
    subTotal: asT<dynamic>(json, 'subTotal'),
    groupOrderID: asT<String>(json, 'groupOrderID'),
    ...
    parsedDate: asT<dynamic>(json, 'parsedDate'),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'productDetails': productDetails.map((e) => e),
...
class GroupData {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'joinedMember': joinedMember.map((e) => e),
    'createdAt': createdAt,
    'updatedAt': updatedAt,
    '__v': v,
  };
